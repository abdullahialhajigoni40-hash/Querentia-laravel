                 ...
                 <div class="mb-6">
                    ...
                    <div>
                        ...
                        <select id="position" name="position" 
                            ...
                            <option value="student" @selected(old('position') === 'student')>Student</option>

                            <option value="researcher" @selected(old('position') === 'researcher')>Researcher</option>

                            <option value="lecturer" @selected(old('position') === 'lecturer')>Lecturer</option>

                            <option value="professor" @selected(old('position') === 'professor')>Professor</option>

                            <option value="phd" @selected(old('position') === 'phd')>PhD Candidate</option>
                ...
                <div class="mb-6">
                    ...
                    <div class="flex items-start">
                        ...
                        <label for="terms" class="ml-2 text-sm text-gray-700">
                            ...
                            I agree to the <a href="{{ route('legal.terms') }}" class="text-purple-600 hover:underline">Terms of Service</a> 

                            and <a href="{{ route('legal.privacy') }}" class="text-purple-600 hover:underline">Privacy Policy</a>. 
