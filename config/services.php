...
return [
    ...
    */
    ...
    'deepseek' => [
        ...
        'retry_attempts' => (int) env('DEEPSEEK_RETRY_ATTEMPTS', 3),
        'cost_per_1k_tokens' => (float) env('DEEPSEEK_COST_PER_1K_TOKENS', 0.0014),
        'streaming' => (bool) env('DEEPSEEK_STREAMING', true),
    ],
    ...
    'openai' => [
        ...
        'cost_per_1k_tokens' => (float) env('OPENAI_COST_PER_1K_TOKENS', 0.03),
        'streaming' => (bool) env('OPENAI_STREAMING', true),
    ],
    ...
    'gemini' => [
        ...
        'cost_per_1k_tokens' => (float) env('GEMINI_COST_PER_1K_TOKENS', 0.00125),
    ...
    'anthropic' => [
        ...
        'cost_per_1k_tokens' => (float) env('ANTHROPIC_COST_PER_1K_TOKENS', 0.015),
        'streaming' => (bool) env('ANTHROPIC_STREAMING', true),
    ],
